...
complete -c tunet-bash -s a -l auth -d 'Auth method' --no-files -ra '4 6 auto'
complete -c tunet-bash -l date-format --no-files -rd 'Format String passed to date command'
